...
layout: page
title: AuthCore
description: Custom Authentication & RBAC System
img: assets/img/projects/authcore.jpg
importance: 1
category: work
github: https://github.com/aayushkrm/AuthCore
---

## AuthCore - Custom Authentication and Role-Based Access Control (RBAC) System

A secure and scalable authentication system built from the ground up with modern security best practices and fine-grained access control.
...
<div class="repositories d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center">
  <div>
    <a href="https://github.com/aayushkrm/AuthCore" target="_blank" class="btn btn-sm z-depth-0" role="button">
